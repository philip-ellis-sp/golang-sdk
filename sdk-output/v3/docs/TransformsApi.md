...
func main() {
    transform := *openapiclient.NewTransform("Timestamp To Date", "dateFormat", "Attributes_example") // Transform | The transform to be created.
...
func main() {
    ...
    transform := *openapiclient.NewTransform("Timestamp To Date", "dateFormat", "Attributes_example") // Transform | The updated transform object (must include \"name\", \"type\", and \"attributes\" fields). (optional)
